...
_C.EXPERIMENT.DEPLOY_FLAG = False
...
# FITNET CFG
_C.FITNET = CN()
_C.FITNET.INPUT_SIZE = (256, 256)
_C.FITNET.HINT_LAYER = 2
_C.FITNET.KD_WEIGHT = 2.0

# AT CFG
_C.AT = CN()
_C.AT.P = 2
_C.AT.KD_WEIGHT = 1000.0
...
_C.INPUT.PADDING = 10 # 256:8 384:12
...
# Sampler for distillation data loading
_C.DATALOADER.DISTILLATION_SAMPLER = 'triplet'
# Number of instance for one batch on distillation 
_C.DATALOADER.DISTILLATION_NUM_INSTANCE = 6
