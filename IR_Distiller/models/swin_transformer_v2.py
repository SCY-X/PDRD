...
class Swin_Transformer_V2(nn.Module):
    def __init__(self, pretrained = False, pretrained_path = "", model_select="swinv2_small_window8_256", projection=512, num_classes=1000):
        ...
        self.fc = ClassBlock(num_channel, num_classes, num_bottleneck=projection)
...
def swin_transformer_v2_base(pretrained=False, pretrained_path="", **kwargs):
    ...
    model = Swin_Transformer_V2(pretrained, pretrained_path,  model_select="swinv2_base_window8_256", projection=kwargs["projection"], num_classes=kwargs["num_classes"])
...
def swin_transformer_v2_small(pretrained=False, pretrained_path="", **kwargs):
    ...
    model = Swin_Transformer_V2(pretrained, pretrained_path, model_select="swinv2_small_window8_256", projection=kwargs["projection"], num_classes=kwargs["num_classes"])
   
    return model


def swin_transformer_v2_tiny(pretrained=False, pretrained_path="", **kwargs):
    model = Swin_Transformer_V2(pretrained, pretrained_path, model_select="swinv2_tiny_window8_256", projection=kwargs["projection"], num_classes=kwargs["num_classes"])
